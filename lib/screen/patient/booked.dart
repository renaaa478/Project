...
import 'package:projectapp/screen/patient/advices.dart';
...
class _BookedState extends State<Booked> {
  ...
  Future<Null> readBook() async {
    String url =
        '${MyCostant().domain}/care/app/booked.php?isAdd=true&pid=$pid';
    try {
      final http.Response response = await http.Client().get(
        url,
      );
            ...
            child: Card(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[Padding(padding: EdgeInsets.only(bottom: 20.0)),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[Padding(padding: EdgeInsets.only(top: 20.0 , bottom: 5.0)),
                        Row(
                          children: [
  ...
  //   String url =
  //       '${MyCostant().domain}/care/app/comment.php?isAdd=true&bid=$bid';
  //   try {
  //     final http.Response response = await http.Client().get(
  //       url,
  //     );
