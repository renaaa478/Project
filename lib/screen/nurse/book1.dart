...
import 'package:projectapp/screen/nurse/advice.dart';
...
class _Book1State extends State<Book1> {
  ...
  Future<Null> readBook() async {
    String url =
        '${MyCostant().domain}/care/app/getbookwhere.php?isAdd=true&nid=$nid';
    try {
      final http.Response response = await http.Client().get(
        url,
      );
  ...
  Future<Null> findAdvice() async {
    ...
    try {
      ...
      if (result != null) {
        ...
        Navigator.push(context, route).then((value) => false);
      }
    } catch (e) {}
  }
                ...
                builder: (context) => SimpleDialog(
                  title: Column(
                    ...
                    children: [
                      ...
                      Text('บริการ : ${getallBooks[index].nameSer}  '),
                      Text(
